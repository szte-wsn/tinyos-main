...
#else
  typedef uint8_t const_uint8_t;
  typedef uint16_t const_uint16_t;
  typedef uint32_t const_uint32_t;
  typedef int16_t const_int16_t;
  typedef int32_t const_int32_t;
  
  #define read_uint8_t(x) *(x)
  #define read_uint16_t(x) *(x)
  #define read_uint32_t(x) *(x)
  
  #define read_int8_t(x) *(x)
  #define read_int16_t(x) *(x)
  #define read_int32_t(x) *(x)
#endif
